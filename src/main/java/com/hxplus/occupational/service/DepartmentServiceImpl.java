...
public class DepartmentServiceImpl implements DepartmentService {
	...
	public Department saveDepartment(DepartmentRequest departmentRequest) {
		return departmentRepository.save(fromReq(new Department(), departmentRequest));
	}
	...
	public Department updateDepartment(Long id,
		...
		return departmentRepository.save(fromReq(findById(id), departmentRequest));
	}
	...
	private Department fromReq(Department department, DepartmentRequest departmentRequest){
